...
export default function Contact() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/xzzebavd', {
        method: 'POST',
        body: formData,
        headers: {
            ...
            <form id="contactForm" onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-slate-50 dark:bg-neutral-950 border border-slate-200 dark:border-neutral-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-400 text-slate-900 dark:text-white disabled:opacity-50"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  disabled={status === 'loading'}
                  className="w-full px-4 py-2 bg-slate-50 dark:bg-neutral-950 border border-slate-200 dark:border-neutral-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:focus:ring-emerald-400 text-slate-900 dark:text-white resize-none disabled:opacity-50"
